...
#body-bg{padding:80px 0 0 0;_padding:0;background:#f1f2f3;}
#page-wrap #main-wrap{margin:0 auto;text-align: left;width:1000px;position:relative;_margin:20px auto 0;}
#page-wrap #top-wrap{margin:0 auto 20px auto;text-align: left;width:1000px;overflow: hidden;}
...
#header .head-bd .nav li a{display:block;height:56px; line-height:58px; font-size:18px;padding:0 10px;margin:0 5px;}
...
#header .head-bd .nav li .dropmenu{background:url(../image/layer_bg.png) repeat #fff;border:#797979 solid 2px;left:-1px;top:58px;position:absolute;}
...
#header .head-bd .search{position:absolute;right:85px;*right:150px;top:14px;float:left;width:238px;_width:240px;height:30px; line-height:30px;background:#fff;border:#858585 1px solid;}
...
#header .head-bd .dorp-right .dropmenu{background:url(../image/layer_bg.png) repeat #F7F8FA;border:#797979 solid 2px;top:48px;right:-19px;position:absolute;width:320px;margin:10px 0 0 0;display:none;}
...
a.top_stick:link,a.top_stick:visited{background:url(../image/ico-back-top.png) no-repeat left top;width:60px;height:60px;display: block;_width:60px;_height:60px;}
...
.user-list-rec li{display: block;float: left;margin: 0 20px 64px 0;padding: 0;position: relative; text-align:center;}
...
.third-party dd{float:left;text-align:center;margin-left:40px;}
...
.ico-qq,.ico-renren,.ico-sina,.ico-qzone,.ico-douban,.ico-taobao,.ico-baidu,.ico-weixin_{background: url(../image/ico-account.png) no-repeat;display:inline-block;cursor:pointer;_background:url(../image/ico-account.gif) no-repeat;width:27px;height:27px;}
...
.ico-weixin_{background-position:-223px 0;margin-right:18px;}
a.ico-weixin_:hover{background-position:-273px 0;}
...
.inter-line a,.inter-line span{background:#fff;padding:0 0 0 5px;margin:-16px 0 0 0;font-weight:300;float:right;color:#555;margin:0\9;}
...
.feed_list .content p.info a:hover .digg-like,
.minh p.info a:hover .digg-like {
...
.more-actions .digg-like-yes,
.feed_list .digg-like-yes {
  color:#0096e6 !important
}

.feed_list .digg-like:hover,
.more-actions .digg-like-yes .digg-like,
.feed_list .digg-like-yes .digg-like {
  background-position:-63px -221px;
}
...
.feed_list .contents img.emot{margin-right: .25rem;}
...
.form-set dd .form-row label{padding:0 10px 0 0}
