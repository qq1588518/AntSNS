...
<title>发表帖子</title>
<meta content="发表帖子 技术交流" name="keywords">
<meta content="技术交流,无论你是技术大神还是菜鸟一枚，在这里总有你能得到的收获" name="description">
...
<link href="./antsns_img/newtz/css.php" rel="stylesheet" type="text/css">
<link rel="stylesheet" href="./antsns_img/newtz/uploadify.css" type="text/css">
...
<script src="./antsns_img/newtz/public_zh-cn.js"></script>
<script src="./antsns_img/newtz/jquery.js"></script>
<script src="./antsns_img/newtz/jquery.form.js"></script>
<script src="./antsns_img/newtz/common.js"></script>
<script src="./antsns_img/newtz/core.js"></script>
<script src="./antsns_img/newtz/module.js"></script>
<script src="./antsns_img/newtz/module.common.js"></script>
<script src="./antsns_img/newtz/jwidget_1.0.0.js"></script>
<script src="./antsns_img/newtz/jquery.atwho.js"></script>
<script src="./antsns_img/newtz/jquery.caret.js"></script>
<script src="./antsns_img/newtz/ui.core.js"></script>
<script src="./antsns_img/newtz/ui.draggable.js"></script>
<script src="./antsns_img/newtz/core.digg.js"></script>
<script src="./antsns_img/newtz/core.comment.js"></script>
<script src="./antsns_img/newtz/core.digg.js"></script>

<script src="./antsns_img/newtz/link.js" type="text/javascript" defer="defer"></script><script src="./antsns_img/newtz/image.js" type="text/javascript" defer="defer"></script><script src="./antsns_img/newtz/map.js" type="text/javascript" defer="defer"></script><script src="./antsns_img/newtz/video.js" type="text/javascript" defer="defer"></script><script src="./antsns_img/newtz/emotion.js" type="text/javascript" defer="defer"></script><style id="umeditor_body_css">.edui-editor-body .edui-body-container img{padding:5px 0px 5px 0px;}</style></head>
  ...
  <div class="header-wrap">
      <div class="head-bd"> 
        ...
        <div class="nav">
          <ul>
                      <li _nav="sec-nav-7">
              <a href="http://localhost/thinksns/index.php?app=public" target="_self">朋友圈</a>
            </li>
                        <li _nav="sec-nav-4" class="current">
              <a href="http://localhost/thinksns/index.php?app=weiba" target="_self" class="app">微吧+</a>
            </li>
                        <li _nav="sec-nav-11">
            ...
            <ul class="clearfix">
              <li model-node="search" class="dorp-right"> 
                  <a href="javascript:void(0);" class="app search-btn"><img src="./antsns_img/newtz/ico-search.png"></a>
              ...
              <li model-node="account" class="dorp-right"><a href="javascript:void(0);" class="app" rel="account-btn"><img rel="account-btn" src="./antsns_img/newtz/ico-set.png"></a>
...
<div style="text-align: center;margin-bottom: 20px;">
    <img src="./antsns_img/newtz/img_decoration.png">
  </div><!--二级导航-->
...
<!-- 全局风格CSS -->
<link href="./antsns_img/newtz/public.css" rel="stylesheet" type="text/css">
<link href="./antsns_img/newtz/layout.css" rel="stylesheet" type="text/css">
<link href="./antsns_img/newtz/form.css" rel="stylesheet" type="text/css">
<link href="./antsns_img/newtz/box.css" rel="stylesheet" type="text/css">
...
<link href="./antsns_img/newtz/weiba.css" rel="stylesheet" type="text/css">
<script type="text/javascript" src="./antsns_img/newtz/weiba.js"></script>
<!-- <script type="text/javascript" src="http://localhost/thinksns/resources/theme/stv1/_static/js/module.form.js"></script> -->

<div id="page-wrap">
  <div id="main-wrap" style="min-height: 661px;">
    <!-- <p class="weiba-location"><a href="http://localhost/thinksns/index.php?app=weiba&mod=Index&act=index">微吧</a>&nbsp;>&nbsp;<a href="http://localhost/thinksns/index.php?app=weiba&mod=Index&act=detail&weiba_id=2">技术交流</a>&nbsp;>&nbsp;发新帖</p> -->
    <div class="weiba-box clearfix">
      <!-- <h3>发新贴</h3> -->
      <form method="post" action="savePost" model-node="weiba_post" onsubmit="return setcontent();" name="weibaPost" enctype="multipart/form-data">
        
        <ul class="add_group">
          <li>
            <div class="c1"><font color="red"> * </font>标题</div>
            <div class="c2">
              <input class="text" style="width:690px; padding:6px 4px;" type="text" name="title" id="title" onkeydown="if(event.keyCode==13){return false;}">
            </div>
          </li>
          <li>
            <div class="c1"><font color="red"> * </font>正文</div>
            <div class="c2" style="line-height:normal;"> <link href="./antsns_img/newtz/umeditor.css" type="text/css" rel="stylesheet">

<div class="edui-container" style="width: 700px; z-index: 20;"><div class="edui-toolbar"><div class="edui-btn-toolbar" unselectable="on" onmousedown="return false"><div class="edui-btn edui-btn-fullscreen" unselectable="on" onmousedown="return false" data-original-title="全屏"> <div unselectable="on" class="edui-icon-fullscreen edui-icon"></div></div><div class="edui-btn edui-btn-emotion" unselectable="on" onmousedown="return false" data-original-title="表情"> <div unselectable="on" class="edui-icon-emotion edui-icon"></div></div><div class="edui-btn edui-btn-bold" unselectable="on" onmousedown="return false" data-original-title="加粗"> <div unselectable="on" class="edui-icon-bold edui-icon"></div><div class="edui-tooltip" unselectable="on" onmousedown="return false" style="z-index: 21; display: none; top: 22px; left: -5.5px;"><div class="edui-tooltip-arrow" unselectable="on" onmousedown="return false"></div><div class="edui-tooltip-inner" unselectable="on" onmousedown="return false">加粗</div></div></div><div class="edui-btn edui-btn-italic" unselectable="on" onmousedown="return false" data-original-title="斜体"> <div unselectable="on" class="edui-icon-italic edui-icon"></div></div><div class="edui-btn edui-btn-underline" unselectable="on" onmousedown="return false" data-original-title="下划线"> <div unselectable="on" class="edui-icon-underline edui-icon"></div></div><div class="edui-splitbutton edui-splitbutton-forecolor" unselectable="on" data-original-title="字体颜色"><div class="edui-btn" unselectable="on"><div unselectable="on" class="edui-icon-forecolor edui-icon"></div><div class="edui-splitbutton-color-label"></div></div><div unselectable="on" class="edui-btn edui-dropdown-toggle"><div unselectable="on" class="edui-caret"></div></div></div><div class="edui-btn edui-btn-removeformat" unselectable="on" onmousedown="return false" data-original-title="清除格式"> <div unselectable="on" class="edui-icon-removeformat edui-icon"></div></div><div class="edui-btn edui-btn-image" unselectable="on" onmousedown="return false" data-original-title="图片"> <div unselectable="on" class="edui-icon-image edui-icon"></div></div><div class="edui-btn edui-btn-link" unselectable="on" onmousedown="return false" data-original-title="超链接"> <div unselectable="on" class="edui-icon-link edui-icon"></div></div><div class="edui-btn edui-btn-insertvideo" unselectable="on" onmousedown="return false" data-original-title="视频"> <div unselectable="on" class="edui-icon-insertvideo edui-icon"></div></div></div><div class="edui-dialog-container"></div></div><div class="edui-editor-body">
<div id="weiba" name = "content" class=" edui-body-container" contenteditable="true" style="width: 680px; min-height: 290px; z-index: 20;"><p><br></p></div></div></div>

<script type="text/javascript" charset="utf-8" src="./antsns_img/newtz/umeditor.config.js"></script>
<script type="text/javascript" charset="utf-8" src="./antsns_img/newtz/umeditor.min.js"></script>
<script type="text/javascript" src="./antsns_img/newtz/zh-cn.js"></script>
<script type="text/javascript">
var initialFrameWidth = '700';
var EditorList = EditorList || {};
EditorList['weiba'] = UM.getEditor('weiba',{zIndex:20,initialFrameWidth:initialFrameWidth,initialStyle:'.edui-editor-body .edui-body-container img{padding:5px 0px 5px 0px;}',imageUrl:U('widget/Upload/save', ['attach_type=editor', 'upload_type=image', 'isAjaxUrl=1','thumb=1','width=660px'])});
</script> </div>
          </li>
          <li>
            <div class="c1">附件</div>
            <div class="c2"><div style="height:31px;">
 <input type="file" name="file" inputname="attach" onchange="core.plugInit('uploadFile',this,'','file');" urlquery="attach_type=weiba_attach" limit="0" event-node="uploadinput">
</div>
          ...
          <li>
            <div class="c1"></div>
        <div class="c2"><input type="submit" value="提交"><a href="javascript:;" class="btn_b mr5" event-node="submit_btn" type="submit" event-args="editor=true"><span>确定</span></a><a href="http://localhost/thinksns/index.php?app=weiba&amp;mod=Index&amp;act=detail&amp;weiba_id=2" class="btn_w"><span>取消</span></a></div>
            <!-- <div class="form-row"><a href="javascript:void(0)" onclick="$('#weiba_post').submit();" class="btn-green-small mr5"><span>确定</span></a><a href="http://localhost/thinksns/index.php?app=weiba&mod=Index&act=detail&weiba_id=2" class="btn-cancel"><span>取消</span></a></div> --> 
          </li>
        </ul>
    ...
    <div class="login-footer">
      <div class="attend-official clearfix">
        <dl>
          ...
          <dd><img src="http://localhost/thinksns/index.php?app=weiba&amp;mod=Index&amp;act=post&amp;weiba_id=2"></dd>
        </dl>
      </div>
...
<!-- 统计代码-->
<div id="site_analytics_code" style="display:none;"> <script src="./antsns_img/newtz/stat.php" language="JavaScript"></script><script src="./antsns_img/newtz/core.php" charset="utf-8" type="text/javascript"></script><a href="http://www.cnzz.com/stat/website.php?web_id=1254932726" target="_blank" title="站长统计">站长统计</a> </div>
<script src="./antsns_img/newtz/online_check.php"></script><script>
  //底部置底
